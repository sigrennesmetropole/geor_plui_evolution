...
```
# filename du certificat (à déposer dans /etc/georchestra/plui-evolution/)
...
Le certificat dont le nom est renseigné doit être déposé dans `/etc/georchestra/plui-evolution/`.
